...
export default function MissionControl() {
  ...
  const [newActivity, setNewActivity] = useState({ type: "task", action: "created", title: "", description: "" });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    addActivity({ type: newActivity.type, action: newActivity.action, title: newActivity.title, description: newActivity.description || undefined, source: "manual" });
    ...
    <main className="min-h-screen p-4 md:p-8">
      ...
      <div className="max-w-4xl mx-auto mb-8 grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          ...
          { label: "Created", value: stats.created, color: "text-purple-400" },
